                ...
                <div class="wrap-page-title">
                    <div class="breakcrums text-center v2">
                        <ul>
                            ...
                            <li><a href="#" class="hover-text">Services</a></li>
                        </ul>
                    </div> <!-- /.breakcrums -->

                    <div class="page-title-heading text-center v2">
                        <h1><a href="#" class="hover-text">Car polish</a></h1>
            ...
            <div class="container clearfix">
                <div class="sidebar-left">
                    ...
                    <div class="widget widget-deal">
                        ...
                        <div class="img">
                            <img src="/website/images/FAQs/men-deal.png" alt="AutoMov">
                        </div>
                        <div class="textbox">
                ...
                <div class="content-page-wrap about-company-wrap pd-left-60">
                    ...
                    <div class="flat-single-service flat-border-bottom pd-bottom-50 mg-bottom-55">
                        <h2 class="title">CAR POLISH</h2>
                        <p class="the-first">Polishing your car is more than just making it look good. It’s a good way to extend the life of the paintwork, improve the finish, and repel dirt and debris. To give your car that mirror-like showroom finish, start with a good coat of the right car polish. In this piece, we’ll walk you through everything you need to know to turn your car into a showstopper.</p>
                        <div class="img">
                            <img src="/website/images/services/our-services/car_polish_full.png" alt="AutoMov">
                        </div>
                        <p>
                            Correct paint defects Most cars have small defects in the paint job, be it lines, an uneven coating, or swirl marks. The good news is a good car polish can help. A polish’s abrasive properties even up the paint job and make the surface look smooth.
                        </p>
                        <p>
                            Exterior foam wash for get rid of dust, abrasions and grime impurities. The polishing covers three-step process includes compounding, polishing and waxing.Get rid of swarl marks, scratches and water spots are all restored with original paint.Protect your paint from fade due to ageing and uv radiations
                        </p>
                        <p>
                            Eliminate scratches. Remove small, shallow scratches with a coat of car polish. The polish can fill in these scratches if they’re small enough, making the overall paint job look much better
                        </p>
                        <p>
                        ...
                        <p>
                            Extend the life of the paint job. Polishes maintain and extend the life of the paint by removing dirt that’s too stubborn for normal washing. It also removes oxidized paint and helps condition the paintwork, making it more resistant to cracking, drying, and peeling.
                        </p>
                        <!-- <blockquote>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat
                        </blockquote> -->
                    </div> <!-- /.flat-single-service -->

                    <!-- <div class="flat-featured-services">
                        <div class="flat-title v4">
                            <h3>Our featured services</h3>
                        </div>
                        <div class="flat-carousel-not-numb" data-auto="false" data-column="3" data-column2="2" data-column3="1" data-gap="1" data-dots="false" data-nav="false" data-loop="true">
                            <div class="flat-iconbox style4 clearfix owl-carousel">
                                <div class="iconbox style4  text-center">
                                    <div class="overlay"></div>
                                    <a href="#">
                                        <div class="iconbox-icon">
                                            <img src="/website/images/home2/icon-workshop-1.png" alt="AutoMov">
                                            <img src="/website/images/home2/icon-workshop-1-hover.png" alt="AutoMov">
                                        </div>
                                        <div class="iconbox-content">
                                            <h4>Tire Pressure Test</h4>
                                            <p>Services consequat luctus at justo auctor metus est donec. Tempus terminal</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="iconbox style4  text-center">
                                    ...
                                    <a href="#">
                                        <div class="iconbox-icon">
                                            <img src="/website/images/home2/icon-workshop-2.png" alt="AutoMov">
                                            <img src="/website/images/home2/icon-workshop-2-hover.png" alt="AutoMov">
                                        </div>
                                        <div class="iconbox-content">
                                            <h4>Maintenance Clocks</h4>
                                            <p>Services consequat luctus at justo auctor metus est donec. Tempus terminal</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="iconbox style4 text-center">
                                    ...
                                    <a href="#">
                                        <div class="iconbox-icon">
                                            <img src="/website/images/home2/icon-workshop-3.png" alt="AutoMov">
                                            <img src="/website/images/home2/icon-workshop-3-hover.png" alt="AutoMov">
                                        </div>
                                        <div class="iconbox-content">
                                            <h4>Free Gas Pump</h4>
                                            <p>Services consequat luctus at justo auctor metus est donec. Tempus terminal</p>
