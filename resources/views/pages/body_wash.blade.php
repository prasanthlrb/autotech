            ...
            <div class="container">
                <div class="wrap-page-title">
                    ...
                    <div class="page-title-heading text-center v2">
                        <h1><a href="#" class="hover-text">Body Wash</a></h1>
            ...
            <div class="container clearfix">
                ...
                <div class="content-page-wrap about-company-wrap pd-left-60">
                    ...
                    <div class="flat-single-service flat-border-bottom pd-bottom-50 mg-bottom-55">
                        <h2 class="title">BODY WASH</h2>
                        <p class="the-first">Our team removes all light or medium scratches, oxidation, stains and paint imperfections giving way to a glossy, durable, fresh painted finish using 3M’s Trizact 1000 sheets blending for better finish. This process cleans and rejuvenates the painted surfaces, engine compartment, tires, glass and rubber or vinyl parts.A special car wash with the unique foaming treatment cleans the car body spotlessly eliminating all the dust and the grime.Getting a car wash will not restore the damage caused by the sun.Exterior foam wash for get rid of dust, abrasions and grime impurities. The polishing covers three-step process includes compounding, polishing and waxing.Get rid of swarl marks, scratches and water spots are all restored with original paint.Protect your paint from fade due to ageing and uv radiations.</p>
                        <div class="img">
                            <img src="/website/images/services/our-services/body_wash_full.png" alt="AutoMov">
                        </div>
                        <p>
                            Preserves paint and plastic finish for a longer duration than normal. Leaves no greasy residue.
                        </p>
                        <p>
                            Enhances the look, shine & durability of vehicles and leather upholstery. Gives streak free visibility for glass and windshields.
                        </p>
                        <!-- <blockquote>
