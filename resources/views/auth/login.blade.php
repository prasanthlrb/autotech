...
<body class="vertical-layout 1-column navbar-sticky bg-full-screen-image footer-static blank-page light-layout " data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <center><img style="width: 400px;height: 150px;margin-bottom: 20px;" class="img-fluid" src="/images/logo/logo.jpeg" alt="branding logo"></center>
                                                <h4 class="text-center mb-2" style="color: #f4a440">Shop Login</h4>
                                            </div>
                                        </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <button type="submit" class="btn btn-primary glow w-100 position-relative">Login<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                                ...
                                <hr>
                                <div style="font-size: 18px;" class="text-center">Don't have an account? <a href="/shop-register">Sign up</a></div>
                            </div>
                        </div>
                    </div>
                </div>
