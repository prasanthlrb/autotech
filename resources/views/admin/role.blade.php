 ...
 <div class="content-overlay"></div>
        ...
        <div class="card-content">
            <div class="card-body card-dashboard">
                <!-- <p class="card-text">In this Table Show All type of shop Information, Booking Details and Payment Details.</p> -->
                            ...
                            <table class="table mt-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Shop</td>
                                        <td>
                                            <div class="checkbox"><input type="checkbox" name="shop_read" id="shop_read" class="checkbox-input">
                                            <label for="shop_read"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="checkbox"><input type="checkbox" name="shop_create" id="shop_create" class="checkbox-input">
                                            <label for="shop_create"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="checkbox"><input type="checkbox" name="shop_edit" id="shop_edit" class="checkbox-input">
                                            <label for="shop_edit"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="checkbox"><input type="checkbox" name="shop_delete" id="shop_delete" class="checkbox-input">
                                            <label for="shop_delete"></label>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Shop Package</td>
                                        <td>
                                            <div class="checkbox"><input type="checkbox" name="shop_package_read" id="shop_package_read" class="checkbox-input">
                                            <label for="shop_package_read"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="checkbox"><input type="checkbox" name="shop_package_create" id="shop_package_create" class="checkbox-input">
                                            <label for="shop_package_create"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="checkbox"><input type="checkbox" name="shop_package_edit" id="shop_package_edit" class="checkbox-input">
                                            <label for="shop_package_edit"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="checkbox"><input type="checkbox" name="shop_package_delete" id="shop_package_delete" class="checkbox-input">
                                            <label for="shop_package_delete"></label>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="checkbox"><input type="checkbox" name="chat_to_shop_read" id="chat_to_shop_read" class="checkbox-input">
                                            <label for="chat_to_shop_read"></label>
                                            </div>
                                        </td>
                                        <td></td>
                                        <td></td>
...
$(document).on('click','.all_click', function(){
  if($(".all_click").prop('checked') == true){
      $.each([ 'dashboard','customer_read','customer_create','customer_edit','customer_delete','shop_read','shop_create','shop_edit','shop_delete','category_read','category_create','category_edit','category_delete','shop_package_read','shop_package_create','shop_package_edit','shop_package_delete','review_ratings_read','service_read','service_create','service_edit','service_delete','service_request_read',
            ...
            'area_edit','area_delete','chat_to_shop_read','chat_to_customer_read','revenue_reports_read','settlement_reports_read','user_read',
