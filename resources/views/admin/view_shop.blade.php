                                ...
                                <li>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="chat-sidebar-name">
                                            <h6 class="mb-0">{{$row->shop_name}}</h6><span class="text-muted"> {{$row->phone}}</span>
                                        </div>
                                    </div>
                                    </a>
                                </li>
      ...
      <div class="card-body">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="profile" aria-labelledby="profile-tab" role="tabpanel">
            ...
            <ul class="list-unstyled">
              <li><i class="cursor-pointer bx bx-phone-call mb-1 mr-50"></i>{{$shop->phone}}</li>
              <li><i class="cursor-pointer bx bx-envelope mb-1 mr-50"></i>{{$shop->email}}</li>
            </ul>

              <div class="row">

                <div class="col-6">
                  <h6><small class="text-muted">shop Name</small></h6>
                  <p>{{$shop->shop_name}}</p>
                </div>
                <div class="col-6">
                  <h6><small class="text-muted">shop ID</small></h6>
                  <p>{{$shop->shop_id}}</p>
                </div>
                <div class="col-6">
                  <h6><small class="text-muted">Emirates ID</small></h6>
                  <p>{{$shop->emirates_id}}</p>
                </div>
                <div class="col-6">
                  <h6><small class="text-muted">Passport Number</small></h6>
                  <p>{{$shop->passport_number}}</p>
                </div>
