                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">shop Package
                                    </li>
                                </ol>
                            </div>
                        </div>
        ...
        <div class="card-content">
            ...
            <div class="table-responsive">
                ...
                <table class="table zero-configuration">
                    ...
                    <tbody>
                    @foreach($shop_package as $key => $row)
                        <tr>
                            <td>{{$key + 1}}</td>
...
function getshoppackageitem(id){
  $.ajax({
    url : '/admin/get-shop-package-item/'+id,
    type: "GET",
    success: function(data)
    {
...
function Delete(id){
    ...
    if (r == true) {
      $.ajax({
        url : '/admin/shop-package-delete/'+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
