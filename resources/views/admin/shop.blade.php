            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">shop List</h5>
                    ...
                    <table class="table zero-configuration">
                        ...
                        @foreach($shop as $key => $row)
                            <tr>
                                ...
                                <td>
                                    @foreach($shop_package as $package)
                                    @if($package->id == $row->shop_package)
                                ...
                                <td><div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; transform: translate3d(-125px, 19px, 0px); top: 0px; left: 0px; will-change: transform;">
                                      ...
                                      <a target="_blank" class="dropdown-item" href="/admin/shop-login/{{$row->id}}"><i class="bx bxs-chat mr-1"></i> shop Login</a>
                                      <a class="dropdown-item" href="/admin/chat-to-shop"><i class="bx bxs-chat mr-1"></i> Chat</a>
                                      <a class="dropdown-item" href="#"><i class="bx bx-lock-alt mr-1"></i> Block</a>
                                      <a class="dropdown-item" href="/admin/view-shop/{{$row->id}}"><i class="bx bx-show-alt mr-1"></i> See Profile</a>
                                    </div>
                                  </div>
                                </td>
                            </tr>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select id="shop_package" name="shop_package" class="form-control">
                            <option value="">SELECT</option>
                            @foreach($shop_package as $row)
                            <option value="{{$row->id}}">{{$row->package_name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                        <label>shop Comission (%)</label>
                        <input type="text" id="shop_commission" name="shop_commission" class="form-control">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-4">
...
$('#add_new').click(function(){
    ...
    $("#form")[0].reset();
    $('#shop_package').removeAttr('disabled');
    action_type = 1;
...
function Edit(id){
  $.ajax({
    ...
    success: function(data)
    {
      ...
      $('select[name=shop_package]').val(data.shop_package);
      $('#shop_package').attr('disabled', 'disabled');
      $('input[name=shop_commission]').val(data.shop_commission);
