...
<body class="horizontal-layout horizontal-menu navbar-sticky 2-columns   footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item">
                    <a class="navbar-brand" href="/vendor/dashboard">
                        <div class="brand-logo"><img style="margin-top:-17px;width: 180px;height: 65px;" class="logo" src="/website/images/logo-white.png"></div>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-left d-inline-block">2020 &copy; AutoTech</span><span class="float-right d-sm-inline-block d-none">Crafted with<i class="bx bxs-heart pink mx-50 font-small-3"></i>by<a class="text-uppercase" href="https://lrbinfotech.com/" target="_blank">LRB Infotech</a></span>
