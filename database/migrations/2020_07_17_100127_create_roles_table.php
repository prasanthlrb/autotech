...
class CreateRolesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('roles', function (Blueprint $table) {
            ...
            $table->string('shop_read')->nullable();
            $table->string('shop_create')->nullable();
            $table->string('shop_edit')->nullable();
            $table->string('shop_delete')->nullable();
            $table->string('shop_package_read')->nullable();
            $table->string('shop_package_create')->nullable();
            $table->string('shop_package_edit')->nullable();
            $table->string('shop_package_delete')->nullable();
            ...
            $table->string('chat_to_shop_read')->nullable();
