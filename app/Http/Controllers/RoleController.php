...
class RoleController extends Controller
{
    public function saveRole(Request $request){
        ...
        $role->shop_read = $request->shop_read;
        $role->shop_create = $request->shop_create;
        $role->shop_edit = $request->shop_edit;
        $role->shop_delete = $request->shop_delete;
        $role->shop_package_read = $request->shop_package_read;
        $role->shop_package_create = $request->shop_package_create;
        $role->shop_package_edit = $request->shop_package_edit;
        $role->shop_package_delete = $request->shop_package_delete;
        ...
        $role->chat_to_shop_read = $request->chat_to_shop_read;
